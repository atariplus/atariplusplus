 ...
 **
 ** $Id: cartsdx.hpp,v 1.9 2015/05/21 18:52:37 thor Exp $
 **
...
/// Class CartSDX
// The CartSDX class implements an SDX supercartridge.
class CartSDX : public Cartridge {
  //
  // The contents of the cart
  class RomPage Rom[256];
  //
  ...
  bool          Disabled;
  //
  // Specific cartridge settings, defined on startup
  //
  // The address range (high-nibble) where the cartridge maps
  // its control word into.
  UBYTE         ControlAddr;
  //
public:
  CartSDX(UBYTE controladr);
  virtual ~CartSDX(void);
  //
